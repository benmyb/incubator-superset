...
ARG SUPERSET_VERSION=release--0.33
...
COPY . /superset-${SUPERSET_VERSION}
WORKDIR /superset-${SUPERSET_VERSION}
RUN pip install --no-cache-dir /superset-${SUPERSET_VERSION}
