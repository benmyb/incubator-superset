...
export const VIZ_TYPES = {
  ...
  echarts_stack: 'echarts_stack',
  echarts_line: 'echarts_line',
  echarts_multiline: 'echarts_multiline',
  highcharts_stack: 'highcharts_stack',
  plotly_multiline: 'plotly_multiline',
...
loadVis(import(/* webpackChunkName: "directed_force" */ './ForceDirected/adaptor.jsx')),
    ...
    [VIZ_TYPES.echarts_funnel]: () =>
loadVis(import(/* webpackChunkName: 'echarts_funnel' */ './EchartsFunnel/adaptor.jsx')),
    [VIZ_TYPES.echarts_stack]: () =>
loadVis(import(/* webpackChunkName: 'echarts_stack' */ './EchartsStack/adaptor.jsx')),
    [VIZ_TYPES.echarts_line]: () =>
loadVis(import(/* webpackChunkName: 'echarts_line' */ './EchartsLine/adaptor.jsx')),
    [VIZ_TYPES.echarts_multiline]: () =>
loadVis(import(/* webpackChunkName: 'echarts_multiline' */ './EchartsMultiLine/adaptor.jsx')),
    [VIZ_TYPES.plotly_multiline]: () =>
loadVis(import(/* webpackChunkName: 'plotly_multiline' */ './PlotlyMultiLine/adaptor.jsx')),
    [VIZ_TYPES.highcharts_stack]: () =>
loadVis(import(/* webpackChunkName: 'highcharts_stack' */ './HighChartsStack/adaptor.jsx')),
