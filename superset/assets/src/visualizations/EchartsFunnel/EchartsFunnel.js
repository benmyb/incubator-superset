...
const propTypes = {
  data: PropTypes.shape({
    ...
    percent_data: PropTypes.arrayOf(
      PropTypes.arrayOf(PropTypes.any),
    ),
  }),
...
function EchartsFunnel(element, props) {
    ...
    toolbox: {
      ...
      feature: {
        myTool0: {
          ...
          icon: 'path://M96 174.4c0 11.6 4 22.8 11.2 31.4l304.4 359.6c7.2 8.6 11.2 19.8 11.2 31.4v214c0 20 11.8 37.6 29.2 44l110 39.6c19.2 7 39.2-8.6 39.2-30.6V596.6c0-11.6 4-22.8 11.2-31.4l304.4-359.6c7.2-8.6 11.2-19.8 11.2-31.4 0-25.6-19.2-46.4-42.8-46.4H138.8C115.2 128 96 148.8 96 174.4z',
          iconStyle: {
            color: '#7CFC00',
          },
          onclick: function () {
 ...
 No.${nfid + 1} with ${sortBy} ${orderDesc ? 'DESC' : 'ASC'}`,
              ...
              series: {
                label: {
                  normal: {
                    formatter: (showPercent) ? function (params) {
                ...
                data: (showPercent) ? (asPercent ? formatShowData(funnelPercentCol, funnelData[nfid], true) : formatShowData(funnelPercentCol, funnelPercent[nfid], false)) : formatShowData(funnelDataCol, funnelData[nfid]),
              },
            });
          },
        },
          ...
          onclick: function () {
            ...
            myChart.setOption({
              ...
              series: {
                ...
                data: (showPercent) ? (asPercent ? formatShowData(funnelPercentCol, funnelData[nfid]) : formatShowData(funnelPercentCol, funnelPercent[nfid])) : formatShowData(funnelDataCol, funnelData[nfid]),
              },
            });
          },
        },
 ...
 No.${nfid + 1} with ${sortBy} ${orderDesc ? 'DESC' : 'ASC'}`,
    ...
    tooltip: {
      ...
      formatter: function (params) {
        ...
        let str = name + '<br/>';
        const tooltipIndex = (showPercent) ? funnelPercentCol.indexOf(name) : funnelDataCol.indexOf(name);
        const tooltipData = (showPercent) ? 'CR: ' + funnelPercent[nfid][tooltipIndex] + '%' : funnelData[nfid][tooltipIndex];
        str += tooltipData + '<br/>';
        return str;
      },
      confine: true,
