  ...
  const option = {
    ...
    tooltip: {
      ...
      position: function (pos, params, dom, rect, size) {
        ...
        const offset = (pos[1] < size.viewSize[1] / 2) ? +(size.viewSize[1] * topPercent * 2) : -(size.viewSize[1] * topPercent * 2);
        return {
          ...
          top: pos[1] - (pos[1] / (size.viewSize[1] * (1 - topPercent * 2))) * (size.contentSize[1]) + offset,
      ...
      formatter: function (params) {
        ...
        if (curSeries !== '' && curSeries !== 'other') {
          ...
          if (showPic && pic !== '' && pic !== undefined) str += '<img style=\'width:150px; height:205px; \' src=\'https://' + pic + '\'/>';
        }
        return str;
      },
      // confine: true,
