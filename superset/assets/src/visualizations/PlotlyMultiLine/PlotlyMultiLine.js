...
function PlotlyMultiLine(element, props) {
  ...
  const allData = formatLayout(CategoricalColorNamespace.getScale(colorScheme).colors, rowNumber, numberFormat, yAxis2Format, dateTimeFormat, metrics, metrics2, groupbyOrder, rawData);
